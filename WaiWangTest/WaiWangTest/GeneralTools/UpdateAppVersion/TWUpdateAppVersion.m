...
@implementation TWUpdateAppVersion

static TWUpdateAppVersion *updateAppManager = nil;
static dispatch_once_t onceToken;
+ (instancetype)shareInstance {
    dispatch_once(&onceToken, ^{
        updateAppManager = [[TWUpdateAppVersion alloc] init];
    });
...
+ (void)hs_updateWithAPPID:(NSString *)appid block:(void(^)(NSString *currentVersion,NSString *storeVersion,NSString *openUrl, BOOL isUpdate))block{
    ...
    NSLog(@"appStoreVersionappStoreVersion = %@",appStoreVersion);
    ...
    {
        TWUpdateAppVersion *updateAppVersion = [TWUpdateAppVersion shareInstance];
